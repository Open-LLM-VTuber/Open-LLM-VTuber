...
- 🎯 **고급 상호작용 기능**:
  - 👁️ 시각 인식 : 카메라, 사진 촬영, 스크린샷을 지원해 AI 수상가 사용자의 모습과 화면을 인식할 수 있습니다.
  - 🎤 음성 인식 : AI가 자신의 지문을 다시 인식하지 않고 사용자의 지문만 인식합니다 .
  - 🫱 터치 인터랙션 : 클릭이나 드래그로 AI 슬라이더와 직접적으로 블록 결합할 수 있습니다.
  - 😊 Live2D 감성 컨트롤 : 백엔드에서 감정 매핑을 설정해 모델의 감성을 세밀하게 제어할 수 있습니다.
  - 🐱 애완동물 모드  : 투명 배경, 항상 위 표시 , 마우스 클릭을 지원하며 AI 위치를 화면에 표시 할 수 있습니다.
  - 💭 AI의 내면 표현: AI가 말하지 않아도 AI의 표정, 생각, 행동을 확인할 수 있습니다.
  - 🗣️ AI 능동 발화 : 사용자가 말을 걸지 않고 AI가 먼저 대화를 시작합니다.
  - 💾 대화 기록 자동 저장: 이전 대화로 다시 돌아갈 수 있습니다.
  - 🌍 TTS 문자 지원: 예를 들어, AI는 일본어로 말하면서 채팅은 중국어로 할 수 있습니다.
