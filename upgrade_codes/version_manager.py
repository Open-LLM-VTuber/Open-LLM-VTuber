...
def _record_upgrade_history(from_version: str, to_version: str, log_path: Union[str, Path] = "upgrade_codes/upgrade_log.json") -> None:
    """
    ...
    Parameters:
        ...
        log_path (str or Path): Path to the log file (default: "upgrade_codes/upgrade_log.json").
    """
    log_entry = {
